...
public class SectionedWorkoutAdapter extends SectionedPendingRemovalAdapter<SectionedWorkoutAdapter.WorkoutViewHolder> implements SectionedListItemTouchHelper.UnderlayButtonClickListener {
    ...
    public class WorkoutViewHolder extends SectionedViewHolder implements View.OnClickListener, View.OnLongClickListener, CompoundButton.OnCheckedChangeListener {
        ...
        // Adapter
        private SectionedWorkoutAdapter adapter;

        private boolean onBind;

        private WorkoutViewHolder(View itemView, SectionedWorkoutAdapter adapter) {
            super(itemView);
    ...
    //region LIFECYCLE
    public SectionedWorkoutAdapter(Context context, View coordLayout){
        ...
        if(coordLayout instanceof CoordinatorLayout){
            ...
            throw new RuntimeException(SectionedWorkoutAdapter.class.getSimpleName() + " was passed a non-coord layout view");
