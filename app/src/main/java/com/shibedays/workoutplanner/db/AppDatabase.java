...
public abstract class AppDatabase extends RoomDatabase {
    ...
    private static class PopulateDBAsync extends AsyncTask<Void, Void, Void>{
        ...
        protected Void doInBackground(final Void... params){
            ...
            card_2.setTimeBetweenSets(20000);
            card_2.setTimeBetweenRounds(45000);
            card_2.setNumOfRounds(3);
            ...
            card_3.setNumOfRounds(3);
            card_3.setTimeBetweenSets(15000);
            ...
            str_1.setNumOfRounds(3);
            str_1.setTimeBetweenSets(15000);
            str_1.setTimeBetweenRounds(45000);
            ...
            str_3.setNumOfRounds(3);
            str_3.setTimeBetweenSets(20000);
            str_3.setTimeBetweenRounds(45000);
            ...
            str_4.setNumOfRounds(3);
            str_4.setEquipmentRequired(true);
            str_4.setTimeBetweenSets(20000);
            str_4.setTimeBetweenRounds(45000);
            ...
            str_5.setNumOfRounds(3);
            str_5.setEquipmentRequired(true);
            str_5.setTimeBetweenSets(15000);
            str_5.setTimeBetweenRounds(45000);
            ...
            str_6.setNumOfRounds(3);
            str_6.setTimeBetweenSets(25000);
            str_6.setTimeBetweenRounds(45000);
            Workout flex_1 = new Workout(Workout.FLEXIBILITY, "Arm Stretches");
            flex_1.addSet(arm_spins);
            flex_1.addSet(arm_cross);
            flex_1.setNumOfRounds(2);
            flex_1.setNoRestFlag(true);
            flex_1.setTimeBetweenRounds(10000);
            Workout flex_2 = new Workout(Workout.FLEXIBILITY, "Leg Stretches");
            flex_2.addSet(toe_touch);
            flex_2.addSet(butterfly);
            flex_2.setNumOfRounds(2);
            flex_2.setNoRestFlag(true);
            flex_2.setTimeBetweenRounds(10000);
